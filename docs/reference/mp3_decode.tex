...
%% Part 2 / Part 3 - for parsing main data
%% Big Values - for parsing Huffman codes in main data
%% Global Gain - for decoding audio
%% Scale Lengths - for parsing scales in main data
%% Table 1 / Table 2 / Table 3 - for parsing Huffman codes in main data
%% Region A / Region B - for parsing Huffman codes in main data
%% Block Type - for determining r0len / r1len / r2len - for Huffman codes
%% Subgain 1 / Subgain 2 / Subgain 3 - for decoding audio
%% Pre Flag - for parsing scales in main data
%% Scale Factor - for parsing scales in main data
%% Count 1 Table - for parsing Huffman codes in main data
...
\begin{figure}[h]
\includegraphics{figures/mp3_main.pdf}
\end{figure}

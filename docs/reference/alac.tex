...
\frac{-1}{|-1|} \times \frac{1}{|1|} = -1 \times 1 = \textbf{-1} \\
\hline
1 & \text{Sample}_0 - \text{Sample}_2 = 16 - 26 =& \textbf{-10} &
\frac{-10}{|-10|} \times \frac{1}{|1|} = -1 \times 1 = \textbf{-1} \\
\hline
2 & \text{Sample}_0 - \text{Sample}_3 = 16 - 25 =& \textbf{-9} &
\frac{-9}{|-9|} \times \frac{1}{|1|} = -1 \times 1 = \textbf{-1} \\
\hline
3 & \text{Sample}_0 - \text{Sample}_4 = 16 - 24 =& \textbf{-8} &
\frac{-8}{|-8|} \times \frac{1}{|1|} = -1 \times 1 = \textbf{-1} \\
\hline
\end{tabular}
\end{table}
\par
...
\frac{-9}{|-9|} \times \frac{-4}{|-4|} = -1 \times -1 = \textbf{1} \\
\hline
1 & \text{Sample}_1 - \text{Sample}_3 = 17 - 25 =& \textbf{-8} &
\frac{-8}{|-8|} \times \frac{-4}{|-4|} = -1 \times -1 = \textbf{1} \\
\hline
2 & \text{Sample}_1 - \text{Sample}_4 = 17 - 24 =& \textbf{-7} &
\frac{-7}{|-7|} \times \frac{-4}{|-4|} = -1 \times -1 = \textbf{1} \\
\hline
3 & \text{Sample}_1 - \text{Sample}_5 = 17 - 23 =& \textbf{-6} &
\frac{-6}{|-6|} \times \frac{-4}{|-4|} = -1 \times -1 = \textbf{1} \\
\hline
\end{tabular}
\end{table}
\begin{align*}

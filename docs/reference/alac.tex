...
\par
\noindent
Note that the channels field is the total number of channels, offset by 1;
\texttt{0} is mono and \texttt{1} is stereo.
The frames within a frameset continue until the value \texttt{0x7} is
encountered in the channel field.
...
Finally, note that all ALAC framesets have padding as needed such that each
...
\begin{figure}[h]
\includegraphics{figures/alac/residual.pdf}
\end{figure}
\begin{itemize}

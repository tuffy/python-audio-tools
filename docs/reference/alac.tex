...
We start by dividing our residual into quotient and remainder value:
\begin{align*}
q &= \lfloor r \div (2^k - 1) \rfloor \\
e &= r - (q \times (2^k - 1))
\end{align*}

If $q$ is greater than 8, we write a unary 9 value
(i.e. the bits `\texttt{1 1 1 1 1 1 1 1 1 0}')

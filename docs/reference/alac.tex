...
channels.
We'll start by encoding all of the non-audio M4A atoms,
most of which are contained within the \ATOM{moov} atom.
Remember, all of an M4A's fields are big-endian.
...
windows & 288 & \texttt{0x000100000000000000000000} \\
& & \texttt{0x000000000001000000000000} \\
& & \texttt{0x000000000000000040000000} \\

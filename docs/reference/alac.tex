...
We'll do this by first calculating the second order residual
...
we'll break our input into \VAR{Left}, \VAR{Right}, \VAR{Side}
and \VAR{Mid} values, as follows:
\begin{align*}
...
The conversion from storage techniques to \VAR{Interlacing Shift} and
\VAR{Interlacing Leftweight} is as follows:
\begin{table}[h]
\begin{tabular}{|l|r|r|}
\hline

...
\item $\text{unsigned}_1 = (0 \times (2^2 - 1)) + (3 - 1) = \textbf{2}$
...
\item $\text{unsigned}_2 = (2 \times (2^2 - 1)) + (3 - 1) = \textbf{8}$
...
\item $\text{unsigned}_3 = (1 \times (2^2 - 1)) = \textbf{3}$\hfill (note that we ``unread'' one 0 bit here)
...
\item $\text{unsigned}_4 = (0 \times (2^2 - 1)) + (3 - 1) = \textbf{2}$

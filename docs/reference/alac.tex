...
{\relsize{-1}
\ALGORITHM{a list of signed PCM samples, sample size, encoding parameters}{a list of 4 or 8 signed LPC values, a block of residual data; or a \textit{residual overflow} exception}

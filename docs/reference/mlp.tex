...
there is one optional \VAR{Matrix Coefficient} per
\VAR{Max Matrix Channel} plus 1, and \VAR{Matrix Noise Shift} is present.
If \VAR{Noise Type} is not set, there is one coefficient per
\VAR{Max Matrix Channel} plus 3, and \VAR{Matrix Noise Shift} is not present.

...
\texttt{FF, F8, CC, 1C, 00, C0, EB, 00, 00, 00, 00,
00, 00, 00, 00}, the frame's CRC-16 can be calculated:
{\relsize{-2}
\begin{align*}
...
\ALGORITHM{the frame's block size and channel assignment, a set of decoded subframe samples\footnote{$subframe_{x~y}$ indicates the $y$th sample in subframe $x$}}{a single list of signed PCM samples}

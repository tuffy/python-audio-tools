...
\subsubsection{Computing LPC Coefficients}
...
\subsubsection{Encoding an LPC Subframe}
...
calculate LPC subframe's residuals based on remaining signed samples, subframe's order, QLP coefficients, QLP precision and QLP shift needed\;
write encoded residual block based on signed residual values\;
...
\subsubsection{Calculating LPC Subframe Residuals}
\ALGORITHM{signed subframe samples, subframe order, QLP coefficients, QLP precision, QLP shift needed}{signed residual values}

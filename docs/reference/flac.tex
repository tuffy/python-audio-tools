...
\While{$PCM~frame~count > 0$}{
  ...
  deduct decoded PCM frame count from $PCM~frame~count$\;
...
\Repeat{last = 1}{
  $last \leftarrow$ \READ 1 unsigned bits\;
...
%% \ALGORITHM
%% \Switch{encoded block size}{
%%   \lCase{0}{block size $\leftarrow$ maximum block size from STREAMINFO}\;
%%   \lCase{1}{block size $\leftarrow$ 192}\;
%%   \lCase{2}{block size $\leftarrow$ 576}\;
%%   \lCase{3}{block size $\leftarrow$ 1152}\;
%%   \lCase{4}{block size $\leftarrow$ 2304}\;
%%   \lCase{5}{block size $\leftarrow$ 4608}\;
%%   \lCase{6}{block size $\leftarrow$ (\READ 8 unsigned bits) + 1}\;
%%   \lCase{7}{block size $\leftarrow$ (\READ 16 unsigned bits) + 1}\;
%%   \lCase{8}{block size $\leftarrow$ 256}\;
%%   \lCase{9}{block size $\leftarrow$ 512}\;
%%   \lCase{10}{block size $\leftarrow$ 1024}\;
%%   \lCase{11}{block size $\leftarrow$ 2048}\;
%%   \lCase{12}{block size $\leftarrow$ 4096}\;
%%   \lCase{13}{block size $\leftarrow$ 8192}\;
%%   \lCase{14}{block size $\leftarrow$ 16384}\;
%%   \lCase{15}{block size $\leftarrow$ 32768}\;
%% \caption{decode block size}
%% }
%% \EALGORITHM
...
%% \ALGORITHM
%% \Switch{encoded sample rate}{
%%   \lCase{0}{sample rate $\leftarrow$ sample rate from STREAMINFO}\;
%%   \lCase{1}{sample rate $\leftarrow$ 88200}\;
%%   \lCase{2}{sample rate $\leftarrow$ 176400}\;
%%   \lCase{3}{sample rate $\leftarrow$ 192000}\;
%%   \lCase{4}{sample rate $\leftarrow$ 8000}\;
%%   \lCase{5}{sample rate $\leftarrow$ 16000}\;
%%   \lCase{6}{sample rate $\leftarrow$ 22050}\;
%%   \lCase{7}{sample rate $\leftarrow$ 24000}\;
%%   \lCase{8}{sample rate $\leftarrow$ 32000}\;
%%   \lCase{9}{sample rate $\leftarrow$ 44100}\;
%%   \lCase{10}{sample rate $\leftarrow$ 48000}\;
%%   \lCase{11}{sample rate $\leftarrow$ 96000}\;
%%   \lCase{12}{sample rate $\leftarrow \text{(\READ 8 unsigned bits)} \times 1000$}\;
%%   \lCase{13}{sample rate $\leftarrow$ \READ 16 unsigned bits}\;
%%   \lCase{14}{sample rate $\leftarrow \text{(\READ 16 unsigned bits)} \times 10$}\;
%%   \lCase{15}{invalid sample rate}\;
%% \caption{decode sample rate}
%% }
%% \EALGORITHM

%% \ALGORITHM
%% \Switch{encoded bps}{
%%   \lCase{0}{bits per sample $\leftarrow$ bits per sample from STREAMINFO}\;
%%   \lCase{1}{bits per sample $\leftarrow$ 8}\;
%%   \lCase{2}{bits per sample $\leftarrow$ 12}\;
%%   \lCase{3}{invalid bits-per-sample}\;
%%   \lCase{4}{bits per sample $\leftarrow$ 16}\;
%%   \lCase{5}{bits per sample $\leftarrow$ 20}\;
%%   \lCase{6}{bits per sample $\leftarrow$ 24}\;
%%   \lCase{7}{invalid bits-per-sample}\;
%% }
%% \caption{decode bps}
%% \EALGORITHM
...
%%   \Case{0}{
%%     channel count $\leftarrow$ 1\;
%%     channel arrangement $\leftarrow$ [front Center]\;
%%   }
%%   \Case{1}{
%%     channel count $\leftarrow$ 2\;
%%     channel arrangement $\leftarrow$ [front Left, front Right]\;
%%   }
%%   \Case{2}{
%%     channel count $\leftarrow$ 3\;
%%     channel arrangement $\leftarrow$ [front Left, front Right, front Center]\;
%%   }
%%   \Case{3}{
%%     channel count $\leftarrow$ 4\;
%%     channel arrangement $\leftarrow$ [front Left, front Right, back Left, back Right]\;
%%   }
%%   \Case{4}{
%%     channel count $\leftarrow$ 5\;
%%     channel arrangement $\leftarrow$ [fL, fR, fC, back/surround left, back/surround right]\;
%%   }
%%   \Case{5}{
%%     channel count $\leftarrow$ 6\;
%%     channel arrangement $\leftarrow$ [fL, fR, fC, LFE, back/surround left, back/surround right]\;
%%   }
%%   \Case{6}{
%%     channel count $\leftarrow$ 7\;
%%     channel arrangement is undefined\;
%%   }
%%   \Case{7}{
%%     channel count $\leftarrow$ 8\;
%%     channel arrangement is undefined\;
%%   }
%%   \Case{8}{
%%     channel count $\leftarrow$ 2\;
%%     channel arrangement $\leftarrow$ [front Left, Difference]\;
%%   }
%%   \Case{9}{
%%     channel count $\leftarrow$ 2\;
%%     channel arrangement $\leftarrow$ [Difference, front Right]\;
%%   }
%%   \Case{10}{
%%     channel count $\leftarrow$ 2\;
%%     channel arrangement $\leftarrow$ [Mid, Side]\;
%%   }
%%   \lCase{11}{reserved channel assignment}\;
%%   \lCase{12}{reserved channel assignment}\;
%%   \lCase{13}{reserved channel assignment}\;
%%   \lCase{14}{reserved channel assignment}\;
%%   \lCase{15}{reserved channel assignment}\;
%% }
%% \caption{channel count/assignment}
%% \EALGORITHM
%% }
...
%% \begin{figure}[h]
%% \includegraphics{figures/flac/frame.pdf}
%% \end{figure}
...
%% UTF-8 was originally designed as a method of encoding
%% Unicode text in a way that's backwards-compatible with ASCII.
%% FLAC uses this encoding as a method to store the frame number
%% such that the smaller numbers use fewer bytes than the larger
%% numbers.

%% One can decode this field in the following way:

%% \begin{figure}[h]
%% \includegraphics{figures/flac/read_utf8.pdf}
%% \end{figure}

%% \pagebreak

%% For example, given the UTF-8 byte \texttt{0x55}:

%% \begin{figure}[h]
%% \includegraphics{figures/utf-8-1.pdf}
%% \end{figure}
%% \par
%% \noindent
%% In this instance, the decoded UTF-8 value is the same as the byte's value.
%% This is how UTF-8 maintains backwards compatibility with ASCII.

%% However, given the UTF-8 bytes \texttt{0xCA 0x95}:
%% \begin{figure}[h]
%% \includegraphics{figures/utf-8-2.pdf}
%% \end{figure}
%% \par
%% \noindent
%% Notice that the unary value from the first byte dictates the
%% total number of bytes, and that the subsequent bytes
%% are prefixed by a fixed, 2-bit header.

%% Finally, given the UTF-8 bytes \texttt{0xE5 0x95 0xAA}:
%% \begin{figure}[h]
%% \includegraphics{figures/utf-8-3.pdf}
%% \end{figure}
...
%% Why does the subframe's block of residuals always have \VAR{Predictor Order}
%% less residuals than the frame's block size?
%% The reason is that FIXED or LPC subframes have \VAR{Predictor Order}
...
%% %%It'd be nice to pad this to one more page
%% %%so that the Rice encoding flowchart and example are on opposite pages
%% %%and the channel assignment and example are on opposite pages
...
%% \begin{figure}[h]
%% \includegraphics{figures/flac/read_residual.pdf}
%% \end{figure}
...
%% \begin{figure}[h]
%% \includegraphics{figures/flac/rice1.pdf}
%% \end{figure}
%% \par
%% \noindent
...
%% \begin{figure}[h]
%% \includegraphics{figures/flac/rice2.pdf}
%% \end{figure}
%% \par
%% \noindent
...
%% \begin{figure}[h]
%% \includegraphics{figures/flac/rice4.pdf}
%% \end{figure}
%% \par
...
%% \begin{figure}[h]
%% \includegraphics{figures/flac/channels.pdf}
%% \end{figure}

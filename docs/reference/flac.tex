...
Calculating the LP coefficients uses the Levinson-Durbin recursive method.\footnote{This algorithm is taken from http://www.engineer.tamuk.edu/SPark/chap7.pdf}

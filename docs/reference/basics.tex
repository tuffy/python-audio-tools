...
fields as follows:
\begin{figure}[h]
\includegraphics{figures/demo.pdf}
\end{figure}
\par
\noindent
...
\begin{figure}[h]
\includegraphics{figures/demo_bigendian.pdf}
\end{figure}
\par
\noindent
...
\begin{figure}[h]
\includegraphics{figures/demo_littleendian.pdf}
\end{figure}
\par
\noindent
\begin{tabular}{c r r r}
...
\begin{figure}[h]
\includegraphics{figures/demo_littleendian_alt.pdf}
\end{figure}
\par
\noindent

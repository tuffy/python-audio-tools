...
\begin{figure}[h]
\includegraphics{figures/musepack/sv7_stream.pdf}
\end{figure}
...
\begin{figure}[h]
\includegraphics{figures/musepack/sv8_stream.pdf}
\end{figure}
\par
\noindent
...
which is big-endian.
\begin{figure}[h]
\includegraphics{figures/musepack/sv8_nut.pdf}
\end{figure}
...
\begin{figure}[h]
\includegraphics{figures/musepack/sv8_sh.pdf}
\end{figure}
\par
\noindent
...
\begin{figure}[h]
\includegraphics{figures/musepack/sv8_rg.pdf}
\end{figure}

\subsection{the EI Packet}
This is information about the Musepack encoder.
\begin{figure}[h]
\includegraphics{figures/musepack/sv8_ei.pdf}
\end{figure}

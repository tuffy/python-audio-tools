...
\end{equation*}
\par
\VAR{Value Size} indicates the size of each value in bits, plus one.
\VAR{Sequence P} is a 1 bit flag.
The total number of lookup values depends on whether \VAR{Lookup Type}
is 1 or 2.
\begin{align*}
...
each \VAR{Value Size} (+ 1) bits large.

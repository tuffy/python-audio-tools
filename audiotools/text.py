...
OPT_INTERACTIVE_METADATA = u"edit metadata in interactive mode"
...
LAB_AVAILABLE_COMPRESSION_TYPES = u"Available compression types for %s:"
...
LAB_TRACKCMP_MISSING = u"missing"
...
LAB_AT_CONFIG_ID3V2_PADDING_YES = u"padded to 2 digits (\"01\", \"02\", etc.)"
LAB_AT_CONFIG_ID3V2_PADDING_NO = u"no padding (\"1\", \"2\", etc.)"
...
LAB_AT_CONFIG_CAN_THUMBNAIL = u"Can create thumbnails"
LAB_AT_CONFIG_NO_PIL = u"(Python Imaging Library not found)"
LAB_AT_CONFIG_THUMBNAIL_FORMAT = u"Default thumbnail format"
LAB_AT_CONFIG_THUMBNAIL_SIZE = u"Default thumbnail size"
...
ERR_NO_COMPRESSION_MODES = u"audio type %s has no compression modes"
...
ERR_URWID_REQUIRED = u"Urwid is required for interactive mode"
ERR_GET_URWID1 = \
...
ERR_NO_THUMBNAILS = u"unable to generate thumbnails"
ERR_THUMBNAIL_SUGGESTION1 = u"please install the Python Imaging Library"
ERR_THUMBNAIL_SUGGESTION2 = \
    u"available at http://www.pythonware.com/products/pil/"
ERR_THUMBNAIL_SUGGESTION3 = u"to enable image resizing"
ERR_INVALID_THUMBNAIL_FORMAT = u"unsupported thumbnail format \"%s\""
ERR_AVAILABLE_THUMBNAIL_FORMATS = u"available formats are: %s"

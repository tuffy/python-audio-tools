 ...
 */
static void audiotools__MD5Transform(uint32_t buf[4], uint32_t const in[16])
{
...
static void byteSwapX16(uint32_t *buf)
{
	register uint32_t x;
 ...
 */
void audiotools__MD5Init(audiotools__MD5Context *ctx)
{
 ...
 */
void audiotools__MD5Final(unsigned char *digest, audiotools__MD5Context *ctx)
{
